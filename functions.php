...
function jm_web_dev_fse_starter_theme_register_block_patterns() {
	...
	$block_pattern_categories = array(
		...
		'jm-web-dev-fse-starter-theme-columns'  => array(
			'label'         => __( 'Columns', 'jm-web-dev-fse-starter-theme' ),
			'categoryTypes' => array( 'jm-web-dev-fse-starter-theme' ),
		),
		...
		'jm-web-dev-fse-starter-theme-grid-query'  => array(
		...
		'jm-web-dev-fse-starter-theme-sidebar'  => array(
			'label'         => __( 'Sidebar', 'jm-web-dev-fse-starter-theme' ),
			'categoryTypes' => array( 'jm-web-dev-fse-starter-theme' ),
		),
	);
