...
export const firstRun = series(
    cleanCSS, cleanJS, parallel(php, html, themeJSON, images, series( styles, editorStyles ), scripts), webfonts, serve, watch
);
...
export const buildDev = parallel(
    php, html, themeJSON, images, series( styles, editorStyles ), scripts, webfonts, translate
);
...
export const bundleTheme = series(
    prodPrep, parallel(php, html, themeJSON, scripts, series( styles, editorStyles ), images), webfonts, translate, prodStringReplace, prodCompress
);

/**
 * Export all imported functions as tasks
 */
export { generateCert, images, php, html, themeJSON, scripts, styles, editorStyles, webfonts, translate, watch, cleanCSS, cleanJS };
